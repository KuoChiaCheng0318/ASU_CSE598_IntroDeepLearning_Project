...
plt.imshow(x_train[4].reshape(128,128), cmap='gray')
plt.show()
plt.imshow(x_train[5].reshape(128,128), cmap='gray')
plt.show()
plt.imshow(x_train[6].reshape(128,128), cmap='gray')
plt.show()
plt.imshow(x_train[7].reshape(128,128), cmap='gray')
plt.show()
